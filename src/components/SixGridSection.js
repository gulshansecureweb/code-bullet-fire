export default function SixGridSection(props){
    ...
    return(
        <div className="row me-row content-ct speaker" id="speakers">
          ...
          <div className="col-md-4 col-sm-6 feature">
            <img src={props.info.img1} className="speaker-img" />
            <h3>Simon Collins</h3>
          ...
          <div className="col-md-4 col-sm-6 feature">
            <img src={props.info.img2} className="speaker-img" />
          ...
          <div className="col-md-4 col-sm-6 feature">
            <img src={props.info.img3} className="speaker-img" />
            <h3>Harry Roberts</h3>
          ...
          <div className="col-md-4 col-sm-6 feature">
            <img src={props.info.img4} className="speaker-img" />
            <h3>Geri Coady</h3>
            <p>Harry is a freelance designer, developer, writer, speaker and front-end architect from the UK, previously working as Senior UI Developer for Sky. He Tweets at...</p>
            <ul className="speaker-social">
              <li><a href="#"><span className="ti-facebook"></span></a></li>
          ...
          <div className="col-md-4 col-sm-6 feature">
            <img src={props.info.img5} className="speaker-img" />
            <h3>Andy Budd</h3>
            <p>Harry is a freelance designer, developer, writer, speaker and front-end architect from the UK, previously working as Senior UI Developer for Sky. He Tweets at...</p>
            <ul className="speaker-social">
              <li><a href="#"><span className="ti-facebook"></span></a></li>
          ...
          <div className="col-md-4 col-sm-6 feature">
            <img src={props.info.img6} className="speaker-img" />
